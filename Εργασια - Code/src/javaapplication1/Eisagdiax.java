...
public class Eisagdiax extends javax.swing.JFrame {

    /**
     * Creates new form eisagdiax
     */
    public Eisagdiax() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Νέος Διαχειριστής");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eisagdiax.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
